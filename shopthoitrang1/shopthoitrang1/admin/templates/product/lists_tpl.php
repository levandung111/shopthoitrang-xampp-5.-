  ...
  <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" >
    ...
    <tbody>
	 ...
	 <a href="index.php?com=product&act=man_list&typeparent=<?=$_GET['typeparent']?>&hienthitc=<?=$items[$i]['id']?>" title="" class="smallButton tipS" original-title="Click để ẩn"><img src="./images/icons/color/tick.png" alt=""></a>
		...
		{
		?>
           <a href="index.php?com=product&act=man_list&typeparent=<?=$_GET['typeparent']?>&hienthitc=<?=$items[$i]['id']?>" title="" class="smallButton tipS" original-title="Click để hiện"><img src="./images/icons/color/xicon.png" alt=""></a>
       <?php }
        ?>     
       ...
       <?php }?>
		...
		?>
            ...
            <?php } else { ?>
         <a href="index.php?com=product&act=man_list&typeparent=<?=$_GET['typeparent']?>&hienthi=<?=$items[$i]['id']?>" title="" class="smallButton tipS" original-title="Click để hiện"><img src="./images/icons/color/xicon.png" alt=""></a>
         <?php } ?>
        </td>
        
        <td class="actBtns">
            <a href="index.php?com=product&act=edit_list&typeparent=<?=$_GET['typeparent']?>&id=<?=$items[$i]['id']?>" title="" class="smallButton tipS" original-title="Sửa sản phẩm"><img src="./images/icons/dark/1234.png" alt=""></a>
          <a  href="index.php?com=product&act=delete_list&typeparent=<?=$_GET['typeparent']?>&id=<?=$items[$i]['id']?>" onclick="CheckDelete('index.php?com=product&act=delete_list&id=<?=$items[$i]['id']?>'); return false;" title="" class="smallButton tipS" original-title="Xóa sản phẩm"><img src="./images/icons/dark/xicon1.png" alt=""></a>       </td>
      </tr>
         <?php } ?>
                </tbody>
