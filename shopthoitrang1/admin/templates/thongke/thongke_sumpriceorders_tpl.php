...
<div class="control_frm">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
	            <li><a href="index.php?com=thongke&act=man"><span>Thống Kê danh thu đơn hàng</span></a></li>
...
<div class="widget">
  <div class="titlee" style="padding-bottom:5px;">
    ...
    <form name="search" action="index.php" method="GET" class="form giohang_ser">
      ...
      <input name="act" value="thongke_sumpriceorder" type="hidden" />
	...
	<br>	<b>Tổng giá tất cả đơn hàng:</b>&nbsp;<span><?=number_format($tongtien,0,',','.')?>&nbsp;VNĐ</span>
