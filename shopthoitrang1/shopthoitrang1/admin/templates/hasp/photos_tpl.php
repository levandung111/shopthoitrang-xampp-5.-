    ...
    <tbody>
       ...
       <td>
		...
		?>
            ...
            <?php } else { ?>
         <a href="index.php?com=hasp&type1=<?=$_REQUEST['type1']?>&act=man_photo&hienthi=<?=$items[$i]['id']?>&idc=<?=$items[$i]['id_photo']?>" title="" class="smallButton tipS" original-title="Click để hiện"><img src="./images/icons/color/xicon.png" alt=""></a>
         <?php } ?>
        </td>
        
        <td class="actBtns">
            <a href="index.php?com=hasp&type1=<?=$_REQUEST['type1']?>&act=edit_photo&id=<?=$items[$i]['id']?>&idc=<?=$items[$i]['id_photo']?>" title="" class="smallButton tipS" original-title="Sửa"><img src="./images/icons/dark/1234.png" alt=""></a>
            <a href="index.php?com=hasp&type1=<?=$_REQUEST['type1']?>&act=delete_photo&idc=<?=$_REQUEST['idc']?>&id=<?=$items[$i]['id']?>" onClick="if(!confirm('Xác nhận xóa')) return false;" onclick="Checkdelete_color('index.php?com=hasp&act=delete_color&id=<?=$items[$i]['id']?>'); return false;" title="" class="smallButton tipS" original-title="Xóa"><img src="./images/icons/dark/xicon1.png" alt=""></a>       
      </td>
      </tr>
         <?php } ?>
                </tbody>
