...
//      print_r($result_ctdonhang);die();
        ...
        <tr id="productct<?=$result_ctdonhang[$i]['id']?>">
          ...
          <td align="center"><?=number_format(($result_ctdonhang[$i]['gia'] * (100 - $result_ctdonhang['giamgia']) / 100),0, ',', '.')?>&nbsp;VNĐ</td>
          ...
          <td align="center" id="id_price<?=$result_ctdonhang[$i]['id']?>"><?=number_format(($result_ctdonhang[$i]['gia'] * (100 - $result_ctdonhang['giamgia']) / 100)*$result_ctdonhang[$i]['soluong'],0, ',', '.')?>&nbsp;VNĐ</td>

         

          <td class="actBtns"><a class="smallButton tipS" original-title="Xóa" href="javascript:del(<?=$result_ctdonhang[$i]['id']?>)"><img src="./images/icons/dark/xicon1.png" alt=""></a></td>
        </tr>
